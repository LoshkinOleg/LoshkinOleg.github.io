...
## The Time Domain
<p align="center">
  <img width="1134" height="727" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/rivendel_ivan_cavini.jpg">
</p>
...
<p align="center">
  <img width="1267" height="300" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/timeDomainSignal.PNG">
</p>
...
<p align="center">
  <img width="1032" height="300" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/timeSignalZoomedIn.PNG">
</p>
...
<p align="center">
  <img width="664" height="1000" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/WraithWorld_Lasaine.jpg">
</p>
...
<p align="center">
  <img width="795" height="535" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/audioPowerSpectrum.PNG">
</p>
...
<p align="center">
  <img width="707" height="852" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/bodePlot.PNG">
</p>
...
<p align="center">
  <img width="750" height="580" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/oneRingInFire.jpg">
</p>
...
<p align="center">
  <img width="480" height="480" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/fullRotation.png">
</p>

Why is that useful? Well, armed with this identity, we can rewrite the very confusing part of the DFT equations as:

<p align="center">
  <img width="311" height="37" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/eulersIdentityForDft.PNG">
</p>
...
## The Visualizer
<p align="center">
  <img width="988" height="741" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/palantir.PNG">
</p>
...
<p align="center">
  <img width="749" height="839" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/cmake.PNG">
</p>
...
<p align="center">
  <img width="301" height="195" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/vs_solution.PNG">
</p>

The code should compile without errors but throw a runtime error about not finding the .dll file for SDL:

<p align="center">
  <img width="422" height="158" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dllError.PNG">
</p>
...
<p align="center">
  <img width="616" height="364" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/moveDlls.PNG">
</p>

The visualizer should now work:

<p align="center">
  <img width="903" height="619" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/workingVisualizer.PNG">
</p>
...
<p align="center">
  <img width="877" height="444" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/main.PNG">
</p>
...
<p align="center">
  <img width="561" height="153" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/todoExample.PNG">
</p>
...
<p align="center">
  <img width="1003" height="445" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/wavOutput.PNG">
</p>
...
## Generating a Sine
<p align="center">
  <img width="600" height="801" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/gandalfGenSine.jpg">
</p>
...
<p align="center">
  <img width="638" height="239" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/callGenerateSine.PNG">
</p>

And move to implementing GenerateSine:

<p align="center">
  <img width="844" height="221" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine0.PNG">
</p>
...
<p align="center">
  <img width="715" height="717" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine1.PNG">
</p>
...
<p align="center">
  <img width="907" height="370" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine2.PNG">
</p>
...
<p align="center">
  <img width="904" height="307" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine3.PNG">
</p>
...
<p align="center">
  <img width="890" height="157" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine4.PNG">
</p>

No, still not right. The signal varies much slower, but too slow. Why is that? Let’s hunt for some hints on Desmos:

<p align="center">
  <img width="869" height="722" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine5.PNG">
</p>
...
<p align="center">
  <img width="729" height="222" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine6.PNG">
</p>
<p align="center">
  <img width="896" height="149" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine7.PNG">
</p>

And perfect! Now, all we need is multiply all of this by the desired frequency and we’re all good!:

<p align="center">
  <img width="721" height="223" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine9.PNG">
</p>
<p align="center">
  <img width="719" height="718" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine8.PNG">
</p>
<p align="center">
  <img width="898" height="317" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/implementGenerateSine10.PNG">
</p>

## Computing the DFT
<p align="center">
  <img width="1280" height="720" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/gandalfGrayFighting.jpg">
</p>
...
<p align="center">
  <img width="840" height="388" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft0.PNG">
</p>
...
<p align="center">
  <img width="325" height="78" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft1.PNG">
</p>

Good, let's try writing the part of the formula that defines one element of the sum:

<p align="center">
  <img width="102" height="25" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/sumElement.PNG">
</p>
...
<p align="center">
  <img width="346" height="124" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft2.PNG">
</p>

So, let’s try computing a single element of the sum again:

<p align="center">
  <img width="494" height="123" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft3.PNG">
</p>

And… well, that's it for this function. Let’s implement EulersFormula and we should be good to go:

<p align="center">
  <img width="534" height="118" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft4.PNG">
</p>

Mind-blowingly difficult, isn’t it? Let’s give it a try!:

<p align="center">
  <img width="715" height="717" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft5.PNG">
</p>
...
<p align="center">
  <img width="384" height="405" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft6.PNG">
</p>
...
<p align="center">
  <img width="323" height="399" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft7.PNG">
</p>
...
<p align="center">
  <img width="548" height="124" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/dft8.PNG">
</p>
...
<p align="center">
  <img width="360" height="411" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/gandalfTheWhite.jpg">
</p>
...
<p align="center">
  <img width="968" height="523" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/idft0.PNG">
</p>
...
<p align="center">
  <img width="52" height="24" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/inverseOfEpow.PNG">
</p>
...
<p align="center">
  <img width="564" height="128" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/idft1.PNG">
</p>
...
<p align="center">
  <img width="717" height="715" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/idft2.PNG">
</p>
...
<p align="center">
  <img width="899" height="148" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/idft4.PNG">
</p>

The samples we’ve generated seem to be way out of the [-1;1] range that a playback device (such as your headphones) expect!:

<p align="center">
  <img width="941" height="451" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/idft3.PNG">
</p>
...
<p align="center">
  <img width="207" height="53" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/idftFormula.PNG">
</p>

We almost had it! We just need to divide the resulting sample by the length of the signal:

<p align="center">
  <img width="581" height="139" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/idft5.PNG">
</p>
...
## To Sum Things Up
<p align="center">
  <img width="1000" height="647" src="{{site.assets_dir}}/Blogposts/TheFrequencyDomainOrThereAndBackAgain/SHIRE_ChaseHenson.jpg">
</p>
